...
var api = {
    ...
    getTopNOfCategory(webusiness,categoryId, size, callback) {
        httpManager.ajax({
            url: getServerHost() + '/product/sub_list_by_category_id?category_id=' + categoryId + '&size=' + size + '&webusinessId=' + webusiness,
            crossDomain: true,
            success: (rs) => {
                callback && callback(rs);
            }
