    ...
    requestCartList() {
        ...
        cartApi.getCartItemsList(localStorage.getItem("wechatId"), localStorage.getItem("businessId"),(rs) => {
            if (rs && rs.success) {
                ...
                console.log("之前",cartData);
                cartData && cartData.map((item, index) => {
                    item.specialtyId = item.productId
                    item.specialtySpecificationId = item.productSpecificationId
                    item.isGroupPromotion = false
                });
                console.log("之后",cartData);
                            ...
                            right={[
                                {
                                    ...
                                    onPress: () => {
                                        ...
                                        this.getStock(item.productSpecificationId);
                                    },
