...
class Payment extends React.Component {
        ...
        products && products.map((item, index) => {
            productApi.getSpecialtySpecificationDetailBySpecialtyID(item.specialtyId, (rs) => {
                if (rs && rs.success) {
                    ...
                    this.state.webusiness = rs.obj[0].specialty.weBusiness
                }
    ...
    payCharge() {
        ...
        console.log("点过立即支付嘛？",!this.state.isCreated)
    ...
    getOrderItems() {
        ...
        const items = this.state.products && this.state.products.map((item, index) => {
            ...
            return {
                ...
                "ownerWebusinessId": parseInt(localStorage.getItem("ownerbusinessId"))
            };
        });
    ...
    cartConfirmOrder() {
        // const openid = 'oRevW1KeWEbJ6CmutatwHT_fdUXM';//测试使用
        // const fee = '1';
