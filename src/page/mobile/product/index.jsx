...
class Product extends React.Component {
            ...
            if (rs && rs.success) {
                ...
                if (!data || JSON.stringify(data) === "[]") {
                    ...
                    this.setState({
                        ...
                        weBisness: data[0].specialty.weBusiness
                    });

                    localStorage.setItem("ownerbusinessId", data[0].specialty.weBusiness.id); //拥有者id
                }
    ...
    render() {
        ...
        if(primaryImages.length === 1){
            ...
            this.state.ifdots = false;
        }
            


        const images = primaryImages && primaryImages.map((img, index) => {
            return <img src={"http://" + getServerIp() + img.mediumPath}
        ...
        return <Layout>
            ...
            <a name="top"/>
{console.log("hehe",this.state.ifdots)}
