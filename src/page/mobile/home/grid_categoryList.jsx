...
import {imgPath} from "../../../config.jsx";
...
export default class CategoryGrid extends React.Component {
    ...
    requestTopNOfCategory(categoryId) {
        console.log("categoryId", categoryId,localStorage.getItem("uid"));
        homeApi.getTopNOfCategory(localStorage.getItem("uid"),categoryId, 6, (rs) => {
    ...
    render() {
        ...
        const content = topOfCategory && topOfCategory.map((item, index) => {
            return <ProductCard key={index}
                                ...
                                cardProductImgUrl={item.iconURL[imgPath]}
