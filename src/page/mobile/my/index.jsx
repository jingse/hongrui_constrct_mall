...
import {Badge, Flex, List, WhiteSpace, WingBlank} from 'antd-mobile';
import './index.less';
...
export default class My extends React.Component {
    ...
    componentWillMount() {
        ...
        this.requestAllOrder(localStorage.getItem("businessId"), 1, 10)
        ...
        myApi.getInfo(wechatIdmy, (rs) => {
            if (rs && rs.success) {
                ...
                if (rs.obj.weBusiness != null)
                    LocalStorageManager.setUid(rs.obj.weBusiness.id)
                if (balance) {
        ...
        myApi.getInfo(wechatIdmy, (rs) => {
            if (rs && rs.success) {
                ...
                if (this.state.isWebusiness) {
                    if (rs.obj.weBusiness != null) {
                        const uid = rs.obj.weBusiness.id;
                        myApi.webusinessLogoEdit(uid, this.headimgurl, (rs) => {
    ...
    checkWebusiness() {
        ...
        if (this.state.isWebusiness && localStorage.getItem("cusuid") == localStorage.getItem("businessId")) {//添加判断uid和获得的uid是不是一样
            return <div>
                <Card>
                    <div className="card_group">
                        <Link to={{pathname: "/my/productMan"}}>
                            <WingBlank>
                                <div className="iconH iconH_inline icon_creatProduct" style={{marginRight: '10px'}}/>
                                <span style={{fontSize: "0.8rem"}}>产品管理</span>
                ...
                <Card>
                    <div className="card_group">
                        <Link to={{pathname: '/my/border', state: 0}}>
                            <WingBlank>
                                <div className="iconH iconH_inline icon_border" style={{marginRight: '10px'}}/>
                                <span style={{fontSize: "0.8rem"}}>订单管理
                            <span className="my_content_right">
                                全部客户订单
                                <Badge text={this.state.allCusaccount} overflowCount={99}/>
                                >
                            </span>
                            </span>
                            </WingBlank>
            ...
            <div className="my_header">
                ...
                <Flex>
                    <Flex.Item style={{flex: '0 0 20%'}}>
                        <img className="my_header_img"
                             src={this.headimgurl ? this.headimgurl : "./images/zz_help_smile.png"}/>
                            ...
                            <Flex>
                                <div style={{overflow: 'hidden', width: '100%'}}>
                                    {this.nickname ? this.nickname :
                                        <a href={wxconfig.redirectUri} style={{color: "#fff"}}>点击登录</a>}
                                </div>
                                <div>
                        ...
                        <Flex.Item style={{marginLeft: '1rem'}}>
                            <Link to={{pathname: '/my/order', state: 2}}>
                                ...
                                <Badge text={this.state.deliverCount}>
                                    <div className="iconH icon_deliver"/>
                                    待发货
                                </Badge>
                            </Link>
                        </Flex.Item>
                        <Flex.Item style={{marginLeft: '1rem'}}>
                            <Link to={{pathname: '/my/order', state: 3}}>
                                ...
                                <Badge text={this.state.receiveCount}>
                                    <div className="iconH icon_receive"/>
                                    待收货
                                </Badge>
                            </Link>
                        ...
                        <Flex.Item style={{marginLeft: '1rem'}}>
                            <Link to={{pathname: '/my/order', state: 4}}>
                                ...
                                <Badge text={this.state.evaluateCount}>
                                    <div className="iconH icon_comment"/>
                                    待评价
                                </Badge>
                            </Link>
                        </Flex.Item>
                        <Flex.Item style={{marginLeft: '1rem'}}>
                            <Link to={{pathname: '/my/order', state: 5}}>
                                ...
                                <Badge text={this.state.refundCount}>
                                    <div className="iconH icon_refund"/>
                                    退款
                                </Badge>
                            </Link>
                        </Flex.Item>
            ...
            {/* <Card>
                <List>
                    ...
                    <Item
                        ...
                        onClick={() => {
                            this.context.router.history.push('/my/balance')
                        }}
                    >
                        余额
                    </Item>
                    <Item
                        ...
                        onClick={() => {
                            this.context.router.history.push('/my/coupon/disposable')
                        }}
                        arrow="horizontal"
                    >
                        一次性电子券
