...
export default class Setting extends React.Component {
    ...
    render() {
        ...
        return <Layout>
            ...
            <List>
                <div style={{display: (this.state.hadBindPhone) ? 'none' : 'line'}}>
                    <List.Item
                        ...
                        arrow="horizontal"
                        onClick={() => {
                            this.context.router.history.push('/my/setting/tel')
                        }}
                    >
                        修改绑定手机号
                    </List.Item>
                ...
                <div style={{display: (this.state.isVip) ? 'inline' : 'none'}}>
                    <DatePicker
                        disabled={(this.state.dateSet !== null)}
                    ...
                    >
                        <List.Item arrow="horizontal" onClick={() => {
                            Toast.info('会员生日仅能设置一次', 2, null, false)
                        }}>会员生日</List.Item>
                    </DatePicker>
                </div>
                <div style={{display: (this.state.isVip) ? 'inline' : 'none'}}>
                    <List.Item
                        onClick={() => {
                            this.context.router.history.push({
                                pathname: '/my/setting/vipAddress', state: {
            ...
            <WhiteSpace/>
            <WhiteSpace/>
            {localStorage.getItem("cusuid")==localStorage.getItem("businessId")?
            <List>
                <div style={{display: (this.state.isWebusiness) ? 'inline' : 'none'}}>
                            ...
                            prompt('设置微商城名称', '', [
                                {text: '取消'},
                                {
                                    text: '设置', onPress: value => {
                                        myApi.webusinessShopNameEdit(webusinessID, value, (rs) => {
                    ...
                    onClick={() => {
                        prompt('设置微商通信地址', '', [
                            { text: '取消' },
                            { text: '设置', onPress: value => {
                                myApi.webusinessShopAddressEdit(webusinessID,value,(rs)=>{
                                    console.log('设置微商城通信地址rs',rs)
                                    if(rs.success == true){
                                        Toast.info('修改成功', 1);
                ...
                {/* <List.Item
                    onClick={() => {this.context.router.history.push({pathname:'/my/setting/shopLogo'})}}
                    arrow="horizontal"
                >
                    设置微商城Logo
                </List.Item> */}
            ...
            <List>
                <List.Item
                    ...
                    arrow="horizontal"
                    onClick={() => {
                        this.context.router.history.push('/my/setting/points')
                    }}
                >
                    积分规则
                </List.Item>
                ...
                <List.Item
                    // thumb="https://zos.alipayobjects.com/rmsportal/UmbJMbWOejVOpxe.png"
                    onClick={() => {
                        this.context.router.history.push('/my/setting/member')
                    }}
                    arrow="horizontal"
                >
                    会员规则
            ...
            <List>
                <List.Item
                    // thumb="https://zos.alipayobjects.com/rmsportal/UmbJMbWOejVOpxe.png"
                    onClick={() => {
                        this.context.router.history.push('/my/setting/help')
                    }}
                    arrow="horizontal"
