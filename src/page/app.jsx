...
/*个人中心-商业订单*/
import BOrder from "./mobile/my/border/index.jsx";
// import OrderDetail from "./mobile/my/order/detail/index.jsx";
// import RefundApply from "./mobile/my/order/refund/index.jsx";
// import RefundDetail from "./mobile/my/order/refund/detail/index.jsx";
// import CommentOn from "./mobile/my/order/comment/index.jsx";
...
import ShopLogo from "./mobile/my/setting/shopLogo/index.jsx";
/*个人中心-手机号绑定*/
import TelBinding from "./mobile/my/tel/index.jsx";
/*个人中心-微商分成*/
import ProfitShare from "./mobile/my/merchant/index.jsx";
/*个人中心-产品管理*/
import ProductManage from "./mobile/my/productMan/index.jsx";
import ProductManageAdd from "./mobile/my/productMan/addProduct/index.jsx";
import ProductManageModify from "./mobile/my/productMan/modifyProduct/index.jsx";
import AddSpecification from "./mobile/my/productMan/addProduct/addSpecification.jsx";
import EditSpecification from "./mobile/my/productMan/addProduct/editSpecification.jsx";
import SpecificationAdd from "./mobile/my/productMan/modifyProduct/addSpecification.jsx";
import SpecificationEdit from "./mobile/my/productMan/modifyProduct/editSpecification.jsx";
            ...
            <MediaQuery query='(max-device-width: 992px)'>
                <Router>
                    <Switch>
                        ...
                        <Route component={BOrder} path='/my/border' exact/>
                        ...
                        <Route component={ShopLogo} path='/my/setting/shopLogo' exact/>

                        <Route component={ProductManage} path='/my/productMan' exact/>
                        <Route component={ProductManageAdd} path='/my/productMan/add' exact/>
                        <Route component={ProductManageModify} path='/my/productMan/modify' exact/>
                        <Route component={AddSpecification} path='/my/productMan/add/addSpecification' exact/>
                        <Route component={EditSpecification} path='/my/productMan/add/editSpecification' exact/>
                        <Route component={SpecificationAdd} path='/my/productMan/edit/addSpecification' exact/>
                        <Route component={SpecificationEdit} path='/my/productMan/edit/editSpecification' exact/>
