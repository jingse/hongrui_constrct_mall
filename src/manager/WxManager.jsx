...
function share() {
    ...
    wx.ready(function () {
        ...
        wx.onMenuShareAppMessage({ 
            title: localStorage.getItem("shopName"), // 分享标题
            desc: '', // 分享描述
            link: 'http://hrmall.bjhongruijiye.com/?uid=' + localStorage.getItem("uid"), // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
            imgUrl: 'http://www.bjhongruijiye.com/resources/upload/image/201905/hbjcsc.jpg', // 分享图标
            success: function () {
